...
const musicProjects = [
  {
    name: "WildNasty",
    genre: "Рэп / Трэп",
    desc: "Дерзкая энергия и авторский звук",
  ...
  },
  {
    ...
    desc: "Слияние архаичных мотивов и электронного звука",
    url: "https://music.yandex.ru",
    cover: null as string | null,
    emoji: "🌙",
  },
  {
    name: "SimpleEnglish",
    genre: "Альтернативный рок 2000-х",
    desc: "Экспериментальный проект — обучение английскому через песни",
    url: "https://music.yandex.ru",
    cover: null as string | null,
    emoji: "✦",
  },
            ...
            <div key={p.name} className="reveal flex flex-col" style={{ border: "1px solid #e8e2d9", transitionDelay: `${i * 0.1}s` }}>
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity"
                  ...
                  <div className="flex flex-col items-center gap-2" style={{ color: "#f9f6f2" }}>
                    ...
                    <p className="text-xs tracking-wide">{musicCovers[i] ? "Изменить" : "Загрузить обложку"}</p>
                  </div>
                </div>
              ...
              <div className="p-5 flex flex-col gap-3 flex-1">
                ...
                <a href={p.url} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 text-xs tracking-wide transition-colors pt-3"
                  style={{ borderTop: "1px solid #e8e2d9", color: "#9b9390" }}
                  ...
                  <Icon name="ArrowUpRight" size={12} className="ml-auto" />
                </a>
              </div>
            </div>
          ))}
